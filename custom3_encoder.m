function f = custom3_encoder(a, E)
% CUSTOM3_ENCODER Customised polar encoder.
%   f = CUSTOM3_ENCODER(a, E) encodes the information bit sequence a, in 
