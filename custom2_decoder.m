function a_hat = custom2_decoder(f_tilde, A, L, min_sum)
% CUSTOM2_DECODER Custom polar decoder.
%   a_hat = CUSTOM2_DECODER(f_tilde, A, L, min_sum) decodes the encoded LLR sequence 
