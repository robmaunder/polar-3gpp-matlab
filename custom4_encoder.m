function f = custom4_encoder(a, E)
% CUSTOM4_ENCODER Customised polar encoder.
%   f = CUSTOM4_ENCODER(a, E) encodes the information bit sequence a, in 
