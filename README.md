# polar-3gpp-matlab
Matlab simulations of the encoder and Successive Cancellation List (SCL) decoder for the New Radio polar code from 3GPP Release 15, as defined in [TS38.212 V15.0.1](https://list.etsi.org/scripts/wa.exe?A3=ind1802B&L=3GPP_TSG_RAN_WG1&E=base64&P=30168360&B=--_024_543CF4C91C60E844AE997DC07D4CC64501AD9C70DGGEML504MBSchi_&T=application%2Fx-zip-compressed;%20name=%22R1-1801292.zip%22&N=R1-1801292.zip&attachment=q&XSS=3) and used in the Public Broadcast Channel (PBCH), Physical Downlink Control Channel (PDCCH) and Physical Uplink Control Channel (PUCCH).
